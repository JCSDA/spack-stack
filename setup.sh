# https://stackoverflow.com/questions/59895/how-can-i-get-the-.-directory-of-a-bash-script-from-within-the-script-itsel
...
. ${SCRIPT_DIR}/spack/share/spack/setup-env.sh
